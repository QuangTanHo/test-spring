...
public class DistrictServiceImpl  implements DistrictService{
    ...
    public Page<DistrictReponse> getDistricts(int page, int size) {
		...
		Page<District> pageDistrict;	
		  pageDistrict = districtRepository.findByDelFlg(Constants.DEL_FLG_0,paging);
	...
	public void deleteDistrict(Long id) {
		...
		District district = this.districtRepository.findByIdAndDelFlg(id,Constants.DEL_FLG_0);
		district.setDelFlg(Constants.DEL_FLG_1);
		this.districtRepository.save(district);
	}
